...
Perhaps you want the label to shrink, but only to a point. If you set a minWidth on the label, that will (should?) have a higher constraint priority and block the element from shrinking any further.
